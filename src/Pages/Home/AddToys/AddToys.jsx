                    ...
                    <form onSubmit={handleAddToys}>
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                            ...
                            <div className="form-control">
                                ...
                                <input type="number" placeholder="$" name='price' className="input input-bordered" required />
                            </div>
                            <div className="form-control">
                                <label className="label">
                            ...
                            <div className="form-control">
                                ...
                                <input type="number" name='ratings' className="input input-bordered" required />
                            </div>
                        </div>
                        <div className="form-control text-center mx-auto w-56 mt-6">
                            <input className="btn  text-white btn-block" type="submit" value="Add Toys" />
                        </div>
                    </form>
                </div>
            </div>
